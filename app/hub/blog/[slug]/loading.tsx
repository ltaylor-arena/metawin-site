    ...
    <div className="min-h-screen animate-pulse">
      ...
      <header className="px-4 md:px-6 pt-6 pb-4">
        <div className="flex gap-2 mb-3">
          <div className="h-6 w-16 bg-[var(--color-bg-tertiary)] rounded" />
          <div className="h-6 w-20 bg-[var(--color-bg-tertiary)] rounded" />
        </div>
      ...
      <div className="px-4 md:px-6 pb-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_280px] gap-8">
          ...
          <div className="min-w-0">
            <div className="aspect-[16/9] rounded-xl bg-[var(--color-bg-tertiary)] mb-8" />
