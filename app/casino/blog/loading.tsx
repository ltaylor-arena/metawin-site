  ...
  return (
    <div className="min-h-screen lg:max-w-[67%] animate-pulse">
      ...
      <div className="px-4 md:px-6 pb-8">
        ...
        {/* Featured post */}
        <div className="p-4 md:p-6 rounded-2xl bg-[var(--color-bg-secondary)] mb-12">
          <div className="aspect-[16/9] md:aspect-[21/9] rounded-xl bg-[var(--color-bg-tertiary)] mb-6" />
          <div className="h-4 w-20 bg-[var(--color-bg-tertiary)] rounded mb-3" />
          <div className="h-7 w-3/4 bg-[var(--color-bg-tertiary)] rounded mb-3" />
          <div className="h-4 w-full max-w-lg bg-[var(--color-bg-tertiary)] rounded mb-4" />
          <div className="h-4 w-40 bg-[var(--color-bg-tertiary)] rounded" />
        </div>

        {/* Section heading */}
        <div className="h-7 w-40 bg-[var(--color-bg-tertiary)] rounded mb-6" />
